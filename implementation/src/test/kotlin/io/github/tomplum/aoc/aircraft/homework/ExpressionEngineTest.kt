...
class ExpressionEngineTest {
    ...
    @Test
    fun exampleTwo() {
        val expression = Lexer().read("2 * 3 + (4 * 5)")
        val engine = ExpressionEngine(expression)
    ...
    @Test
    fun exampleThree() {
        val expression = Lexer().read("5 + (8 * 3 + 9 + 3 * 4 * 3)")
        val engine = ExpressionEngine(expression)
    ...
    @Test
    fun exampleFour() {
        val expression = Lexer().read("5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))")
        val engine = ExpressionEngine(expression)
    ...
    @Test
    fun exampleFive() {
        val expression = Lexer().read("((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2")
        val engine = ExpressionEngine(expression)
